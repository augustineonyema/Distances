...
We welcome all contributions to MDAKit!

Contributions can take many forms, such as:

* sharing bug reports or feature requests through the [Issue Tracker](https://github.com/augustineonyema/mdakit/issues)
...
The second two options both involve making a [pull request](https://github.com/augustineonyema/mdakit/pulls) .
