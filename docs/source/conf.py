...
latex_documents = [
    (master_doc, "mdakit.tex", "MDAKit Documentation",
     "mdakit", "manual"),
]
...
man_pages = [
    (master_doc, "mdakit", "MDAKit Documentation",
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, "mdakit", "MDAKit Documentation",
     author, "mdakit", "Calculate the distances between amino acid residues",
     "Miscellaneous"),
]
